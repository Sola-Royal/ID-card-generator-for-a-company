...
function prev(){
      ...
      let inDesign = document.getElementById("inDesign").value;
      ...
      ctx.fill();
      ctx.fillStyle = "#fff";
      ctx.fillText("ROYALPEDA", 10, 25);
      ctx.font = "16px Arial";
      ctx.fillText("Consulting Ltd", 15, 45);
      ctx.drawImage(logo, 230, 3, 50, 50);
      ctx.fillStyle = "#000";
      ctx.fillText(name.innerHTML, 110, 90);
      ctx.fillText(design.innerHTML, 110, 115);
